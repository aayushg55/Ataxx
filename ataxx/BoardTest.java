...
public class BoardTest {
    ...
    public void testPass() {
        Board b = new Board();
        String[] moves = {"a7-b7", "a1-b1", "g1-f1", "g7-f7"};
        b.setBlock('c', '1');
        b.setBlock('d', '1');
        b.setBlock('a', '2');
        b.setBlock('b', '2');
        ...
        makeMoves(b, moves);
        checkBoard(b, GAMEBLOCK);

        assertTrue(PieceColor.EMPTY.equals(b.getWinner()));

    }
    private static final PieceColor[][] GAMEBLOCK = {
            {RED, RED, BLOCKED, BLOCKED, BLOCKED, BLUE, BLUE},
            {BLOCKED, BLOCKED, BLOCKED, BLOCKED, BLOCKED, BLOCKED, BLOCKED},
            {BLOCKED, BLOCKED, BLOCKED, BLOCKED, BLOCKED, BLOCKED, BLOCKED},
            {EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY},
            {BLOCKED, BLOCKED, BLOCKED, BLOCKED, BLOCKED, BLOCKED, BLOCKED},
            {BLOCKED, BLOCKED, BLOCKED, BLOCKED, BLOCKED, BLOCKED, BLOCKED},
            {BLUE, BLUE, BLOCKED, BLOCKED, BLOCKED, RED, RED}
    };
}
