 ...
 */
class Move {
    /** String representation of side length 7. */
    public static final char SIDEC = '7';
    ...
    private Move(int col0, int row0, int col1, int row1) {
        ...
        _isExtend = Math.abs(col0 - col1) <= 1
                && Math.abs(row0 - row1) <= 1;
        _isJump = !_isExtend && Math.abs(col0 - col1) <= 2
                && Math.abs(row0 - row1) <= 2;
    }
